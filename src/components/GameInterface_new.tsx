    ...
    <div className="max-w-6xl mx-auto px-6 space-y-8">
      ...
      <div className="brutal-container bg-secondary text-neutral relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-0 right-0 w-32 h-32 bg-accent transform rotate-45"></div>
        </div>
        ...
        <div className="relative z-10 flex justify-between items-start">
          <div>
            ...
            <div className="brutal-text text-neutral mb-2">
          ...
          <div className="text-right">
            <div className="text-6xl mb-4 animate-glitch">👁️</div>
            <div className="brutal-text text-accent">DIVINE_OBSERVER</div>
            <div className="brutal-text text-neutral text-sm">OMNIPOTENT_MODE</div>
          </div>
        </div>
      </div>

      {/* World Status Dashboard */}
      <div className="brutal-grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="brutal-container">
          ...
          {currentEvent.choices && currentEvent.choices.length > 0 && (
            <div className="space-y-4">
              ...
              <div className="brutal-grid grid-cols-1 md:grid-cols-2 gap-4">
                {currentEvent.choices.map((choice, index) => (
                  <button
                    key={index}
                    className="brutal-button-primary p-6 text-left transition-all duration-200 hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-brutal-lg"
